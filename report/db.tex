...
\title{\textbf{Relazione Progetto di Ingegneria del Software\\ \large Appendice A: Modello del Database}}
\author{Simone ...} % Sostituisci con il tuo nome
\date{Giugno 2025}

\begin{document}

% In un documento completo, questa sezione sarebbe un capitolo o un'appendice.
% Per un file separato, possiamo usare \maketitle o semplicemente iniziare con \section.
