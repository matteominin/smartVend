...
('worker1@example.com', 'Alice', 'password', 'Johnson'),
('worker2@example.com', 'Bob', 'password', 'Williams'),
('customer1@example.com', 'Charlie', 'password', 'Brown'),
('customer2@example.com', 'Diana', 'password', 'Prince'),
('customer3@example.com', 'John', 'password', 'Doe');
