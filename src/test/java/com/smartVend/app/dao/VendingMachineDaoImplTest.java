...
import com.smartvend.app.dao.impl.VendingMachineDaoImpl;
...
class VendingMachineDaoImplTest {
    ...
    private VendingMachineDaoImpl vendingMachineDao;
    ...
    void setUp() {
        ...
        try {
            var field = VendingMachineDaoImpl.class.getDeclaredField("entityManager");
